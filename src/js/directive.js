    ...
    return {
        ...
        link: function (scope, element) {
            var Clock = function() {
                ...
                _self.setTime = function() {
                    var tmpHour = gamesService.hours > 12 ? gamesService.hours - 12 : gamesService.hours + gamesService.minutes / 60;
                    var degHour = tmpHour * 360 / 12;
                    var degMinute = gamesService.minutes * 360 / 60;
